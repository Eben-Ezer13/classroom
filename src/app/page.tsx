...
const FEATURES = [
  ...
  },
  {
    ...
    text: 'Cours, TD, TP, corrections et sujets d’examen, classés par module et par semestre.',
  },
  {
    icon: IconClock,
  ...
  {
    icon: IconMegaphone,
    title: 'Annonces hiérarchisées',
    text: 'Une annonce urgente se distingue immédiatement des informations courantes.',
  },
  {
    icon: IconPoll,
    title: 'Sondages',
    text: 'Décidez collectivement d’une date de rattrapage ou d’un choix de sujet.',
  },
  {
    icon: IconBell,
    title: 'Notifications',
    text: 'Chaque publication prévient la classe, avec compteur de non-lus.',
  },
]
    ...
    <div className="min-h-dvh flex flex-col">
      ...
      <main className="flex-1">
        <section className="px-4 sm:px-8 py-16 sm:py-24 max-w-5xl mx-auto text-center">
          ...
          <p className="mt-5 text-[15px] sm:text-[17px] leading-relaxed text-[var(--text-2)] max-w-2xl mx-auto">
            Le délégué publie le programme, les ressources et les échéances.
            Chaque étudiant retrouve son espace personnel, à jour, sur mobile
      ...
      <footer className="border-t border-[var(--border)] px-4 sm:px-8 py-5">
        <p className="text-[12.5px] text-[var(--text-3)] text-center">
          Plateforme de gestion de classe — accès réservé aux membres inscrits.
        </p>
      </footer>
    </div>
  )
